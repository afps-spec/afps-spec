...
- **GitHub Security Advisories**: Use the [Security Advisories](https://github.com/afps-spec/afps-spec/security/advisories/new) feature on this repository.
- **Email**: [security@afps.dev](mailto:security@afps.dev)
